...
<div class={
    ...
    || (status === 'PENDING' && 'bg-yellow-100 dark:bg-yellow-700/40 text-yellow-400 before:bg-yellow-400')
    || (status === 'CANCELLED' && 'bg-red-100 dark:bg-red-800/30 text-red-500 before:bg-red-500')
    )
}>
    <span>{status}</span>
</div>
